...
function HappyEnding.takeOutCards(lastSeat,handsInfo,cardPoints,currSeat,level)
	...
	local data ={
		[1]={
			...
			--地主出大于等于7的牌有2+kk的时候不上大王
			"lastSeat==0 and currSeat==1 and type==1 and value>=7 and islordCardsHas(4,.*,13,13,16) then pass",
			--地主出大于等于7的牌有小王+kk的时候不上大王
			"lastSeat==0 and currSeat==1 and type==1 and value>=7 and islordCardsHas(4,.*,13,13,15) then pass",
		},
		[2]={ 
